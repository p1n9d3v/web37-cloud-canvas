/**
 * ACG의 Inbound Rule 리스트 제거 요청 타입
 * @see {@link https://api.ncloud-docs.com/docs/compute-vserver-acg-removeaccesscontrolgroupinboundrule}
 */
export type RemoveAccessControlGroupInboundRuleRequest = {
    /**
     * 리전 코드
     * Inbound Rule이 제거될 ACG의 리전(Region) 결정 가능
    ...
    /**
     * VPC 번호
     * Inbound Rule이 제거될 ACG의 VPC를 결정함
    ...
    accessControlGroupRuleList: Array<{
         ...
         * 접근 소스를 IP 주소 블록과 ACG 번호중 한 가지로 결정 가능.
